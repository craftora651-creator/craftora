...
import { 
  ...
  MdShoppingBasket,
  MdAttachMoney,
  MdTimeline as MdTimelineIcon,
  MdShowChart as MdShowChartIcon,
  MdMultilineChart as MdMultilineChartIcon,
  MdDonutLarge as MdDonutLargeIcon,
  MdScatterPlot as MdScatterPlotIcon,
  MdBubbleChart as MdBubbleChartIcon,
  MdLineChart,
  MdBarChart as MdBarChartIcon,
  MdPieChart as MdPieChartIcon,
  MdShowChart as MdShowChartIcon,
  MdTimeline as MdTimelineIcon,
  MdTrendingUp as MdTrendingUpIcon,
  MdTrendingDown as MdTrendingDownIcon,
  MdTrendingFlat as MdTrendingFlatIcon,
  MdAttachMoney as MdAttachMoneyIcon,
  MdEuro,
  MdMonetizationOn,
  MdPaid,
  MdPriceChange as MdPriceChangeIcon,
  MdPriceCheck as MdPriceCheckIcon,
  MdReceipt as MdReceiptIcon,
  MdReceiptLong,
  MdShoppingCart,
  MdShoppingBag,
  MdShoppingBasket,
